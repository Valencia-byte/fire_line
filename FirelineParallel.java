...
/**
 * Parallel Fork/Join version of the Fireline wildfire simulation.
 *
 * Same command-line interface, console output and image output as
 * FirelineSerial, so the two can be run and diffed directly against each
 * other. The only functional difference is that the interior region update
 * each timestep is performed by a Fork/Join FireTask tree instead of a
...
public class FirelineParallel {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.printf("Sequential cutoff (cells): %d%n",
                    map.getSequentialCutoff());
            System.out.printf("ForkJoinPool parallelism: %d%n",
